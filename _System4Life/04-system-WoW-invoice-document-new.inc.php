...
?>
    ...
    if($read->getResult()):
                    ...
                    foreach($read->getResult() as $key):
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php endif; ?><br/>
                                <?php if($key['taxa'] == 0): ?>
                                    <small style="font-size: 6pt!important;"><?= $key['TaxExemptionReason']; ?></small><br/>
                                <?php endif; ?>
        ...
        <div class="footer-small">
            <div class="cripton-silvio">
                <div class="cripton-silvio-a">
                    ...
                    <div class="Uno ap">
                        ...
                        <div class="right"><?= $k['settings_banco'] ?></div>
                    </div>
                    <label class="Uno">
                        <div class="left">NIB</div>
                        <div class="right"><?= $k['settings_nib'] ?></div>
                    </label>
                    <label class="Uno">
                        <div class="left">IBAN</div>
                        <div class="right"><?= $k['settings_iban'] ?></div>
                    </label>
                    <label class="Uno af">
                        <div class="left">SWIFT/BIC</div>
                        <div class="right"><?= $k['settings_swift'] ?></div>
                    </label>
            ...
            <div class="silvio-400">
                <img src="./uploads/<?= $key['gallery_cover_1']; ?>" class="img-400"/>
                <img src="./uploads/<?= $key['gallery_cover_2']; ?>" class="img-400"/>
                <img src="./uploads/<?= $key['gallery_cover_3']; ?>" class="img-400"/>
                <img src="./uploads/<?= $key['gallery_cover_4']; ?>" class="img-400"/>
                <img src="./uploads/<?= $key['gallery_cover_5']; ?>" class="img-400"/>
                <img src="./uploads/<?= $key['gallery_cover_6']; ?>" class="img-400"/>
            </div>
        </div>
    <?php
    endif;
