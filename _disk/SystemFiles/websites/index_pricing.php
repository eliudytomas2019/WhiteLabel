<div class="row align-items-center">
    ...
    <div class="col-auto ms-auto d-print-none">
        <div class="btn-list">
            ...
            <a href="Admin.php?exe=websites/create_pricing" class="btn btn-primary">Criar novo</a>
        </div>
    </div>
</div>
<br/>
    ...
    <div class="card">
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                $Pager = new Pager("Admin.php?exe=websites/index_pricing&page=");
                ...
                if($read->getResult()):
                    foreach ($read->getResult() as $key):
                        ...
                        <tr>
                            ...
                            <td><?= $key["preco"]; ?></td>
                            <td>
                                <a href="Admin.php?exe=websites/index_pricing&postId=<?= $key['id']; ?>&action=status" class="btn btn-sm btn-primary"><?= $staus[$key['status']]; ?></a>&nbsp;
                                <a href="Admin.php?exe=websites/update_pricing&postId=<?= $key['id']; ?>" class="btn btn-sm btn-warning">Editar</a>&nbsp;
                                <a href="Admin.php?exe=websites/index_pricing&postId=<?= $key['id']; ?>&action=delete" class="btn btn-sm btn-danger">Apagar</a>&nbsp;
