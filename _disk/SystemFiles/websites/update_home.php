<div class="page-header d-print-none">
    <div class="row align-items-center">
        ...
        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
                <a href="Admin.php?exe=websites/index_home" class="btn btn-warning d-none d-sm-inline-block">
                ...
                <div class="card-body">
                    <div id="getResult">
                        ...
                        if ($ClienteData && $ClienteData['SendPostFormL']):
                            ...
                            $Count = new Websites();
                            $Count->UpdateHome($logoty, $ClienteData, $postId);

                            WSError($Count->getError()[0], $Count->getError()[1]);
                        else:
                            $Read = new Read();
                            $Read->ExeRead("website_home", "WHERE id=:i", "i={$postId}");
                            if($Read->getResult()):
