<div class="page-header d-print-none">
    <div class="row align-items-center">
        ...
        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
                <a href="Admin.php?exe=websites/index_team" class="btn btn-warning d-none d-sm-inline-block">
                ...
                <div class="card-body">
                    <div id="getResult">
                        ...
                        if ($ClienteData && $ClienteData['SendPostFormL']):
                            ...
                            $Count = new Websites();
                            $Count->UpdateTeam($logotype, $ClienteData, $postId);

                            WSError($Count->getError()[0], $Count->getError()[1]);
                        else:
                            $Read = new Read();
                            $Read->ExeRead("website_team", "WHERE id=:i", "i={$postId}");
                            if($Read->getResult()):
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="cargo" id="cargo" value="<?php if (!empty($ClienteData['cargo'])) echo $ClienteData['cargo']; ?>" class="form-control"  placeholder="Cargo">
                            </div>
                        </div>
