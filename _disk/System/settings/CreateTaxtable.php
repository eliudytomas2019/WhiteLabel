    ...
    <div class="col-lg-9">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal" method="post" action="" name = "FormTaxTable"  enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="mb-3">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="description" id="description" class="form-control" value="<?php if (!empty($ClienteData['description'])) echo $ClienteData['description']; ?>" placeholder="Descrição">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <input type="text" min="0" max="100" name="taxPercentage" id="taxPercentage" class="form-control" value="<?php if (!empty($ClienteData['taxPercentage'])) echo $ClienteData['taxPercentage']; ?>" placeholder="Porcentagem da Taxa">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="mb-3">
                                <label class="form-label">Montante de imposto</label>
                                <input type="text" name="taxAmount" id="taxAmount" class="form-control" value="<?php if (!empty($ClienteData['taxAmount'])) echo $ClienteData['taxAmount']; ?>" placeholder="Montante de Imposto">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="TaxCountryRegion" id="TaxCountryRegion" class="form-control" value="<?php if (!empty($ClienteData['TaxCountryRegion'])) echo $ClienteData['TaxCountryRegion']; ?>" placeholder="País ou Região do Imposto">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="TaxExemptionReason" id="TaxExemptionReason" class="form-control">
