...
<div class="page-header d-print-none">
    <div class="row align-items-center">
        ...
        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
                <a href="panel.php?exe=marcas/index<?= $n; ?>" class="btn btn-primary d-none d-sm-inline-block">
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h5 class="modal-title">Atualizar ficha de Marcas</h5>
        </div>
        <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div id="getResult">
                            ...
                            if ($ClienteData && $ClienteData['SendPostForm']):
                                ...
                                $ReadUser = new Read;
                                $ReadUser->ExeRead("cv_marcas", "WHERE id = :userid AND id_db_settings=:i", "userid={$userId}&i={$id_db_settings}");
