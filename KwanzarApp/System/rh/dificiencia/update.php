...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?= HOME; ?>panel.php?exe=rh/dificiencia/index<?php if($level >= 4): echo '&id_db_settings='.$id_db_settings; endif; ?>">Dificiência</a></li>
        </ol>
    </div>
</div>
...
<div class="container-fluid">
    <div class="styles">
        <a href="?exe=rh/dificiencia/index<?= $n; ?>" class="btn btn-primary btn-sm">
            Voltar
        </a>&nbsp;
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Dificiência</h4>
                    <div class="basic-form">
                        ...
                        if ($ClienteData && $ClienteData['SendPostForm']):
                            $Count = new RH();
                            $Count->UpdateDificiencia($userId, $ClienteData, $id_db_settings);
                            ...
                            $ReadUser = new Read;
                            $ReadUser->ExeRead("rh_dificiencia", "WHERE id = :userid AND id_db_settings=:i", "userid={$userId}&i={$id_db_settings}");
                        ...
                        <form class="form-horizontal" method="post" action="" name = "SendPostForm"  enctype="multipart/form-data">
                            <div class="form-group">
                                <input type="text"  class="form-control " placeholder="Dificiência" name="dificiencia" value="<?php if (!empty($ClienteData['dificiencia'])) echo $ClienteData['dificiencia']; ?>">
                            </div>
                            <div class="form-group">
