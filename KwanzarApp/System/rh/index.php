...
include_once("_rh_includes/my-modal-rh-nacionalidades-settings.inc.php");
?>
...
<div class="container-fluid">
    <div class="styles">
        <a href="javascript:void()" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#nacionalidades">
            CRIAR NOVA
        </a>&nbsp;
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive" id="getResult">
                        <?php require_once("_rh_includes/body-nacionalidades-settings.inc.php"); ?>
                    </div>
                </div>
            </div>
        </div>
