...
<div class="container-fluid">
    <div id="styles">
        <a href="<?= HOME; ?>panel.php?exe=supplier/index<?= $n; ?>" class="btn btn-primary btn-icon-split btn-sm">
                    ...
                    <div class="basic-form">
                        <form class="form-horizontal" method="post" action="" name = "SendPostForm"  enctype="multipart/form-data">
                            ...
                            if ($ClienteData && $ClienteData['SendPostForm']):
                                ...
                                $ReadUser = new Read;
                                $ReadUser->ExeRead("cv_supplier", "WHERE id = :userid AND id_db_settings=:i", "userid={$userId}&i={$id_db_settings}");
