...
<div class="container-fluid">
    <div class="styles">
        <a href="?exe=category/index<?= $n; ?>" class="btn btn-primary btn-sm">
            Voltar
        </a>&nbsp;
    </div>
                    ...
                    <div class="basic-form">
                        ...
                        <form class="form-horizontal" method="post" action="" name = "SendPostForm"  enctype="multipart/form-data">
                            <div class="form-group">
                                <input type="text"  class="form-control " placeholder="Categoria" name="category_title" value="<?php if (!empty($ClienteData['category_title'])) echo $ClienteData['category_title']; ?>">
                            </div>
                            <div class="form-group">
                                <textarea name="category_content" class="form-control" placeholder="Observações"><?php if (!empty($ClienteData['category_content'])) echo $ClienteData['category_content']; ?></textarea>
                            </div>
