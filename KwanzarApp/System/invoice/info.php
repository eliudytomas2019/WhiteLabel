...
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Relatório de Despesas</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="<?= HOME; ?>panel.php?exe=spending/index?<?= $n; ?>">Despesas</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            <li class="nav-item">
                <a href="<?= HOME; ?>panel.php?exe=invoice/info<?= $n; ?>">Relatório de Despesas</a>
            </li>
        </ul>
    </div>
    <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    <label>-</label><br/>
                                    <a href="javascript:void " class="btn btn-success btn-sm" onclick="SearchSpending()">Pesquisar</a>
                                </div>
                            </div>
                        </div>
                    </div>
