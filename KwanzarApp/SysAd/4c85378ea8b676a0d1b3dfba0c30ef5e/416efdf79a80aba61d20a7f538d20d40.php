            ...
            <form  method="post" action="" name = "SendPostForm"  enctype="multipart/form-data" class="card">
                ...
                <div class="card-body">
                    ...
                    if ($ClienteData && $ClienteData['SendPostForm']):
                        ...
                        $Count = new WSInfo();
                        $Count->ExeUpdate($ClienteData, $logoty, $postId);
                        ...
                        $System->ExeRead("ws_services", "WHERE id=:i", "i={$postId}");

                        if($System->getResult()):
                            $ClienteData = $System->getResult()[0];
                        endif;
                    endif;
                    ?>
                ...
                <div class="card-action">
                    <input type="submit" name="SendPostForm" class="btn btn-primary btn-sm" value="Atualizar"/>
                </div>
            </form>
        </div>
    </div>
