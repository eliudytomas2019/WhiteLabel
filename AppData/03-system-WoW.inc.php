...
$TypeDoc       = strip_tags(trim($_GET['TypeDoc']));
$Itens_id      = strip_tags(trim($_GET['Itens_id']));
$Categories_id = strip_tags(trim($_GET['Categories_id']));
$Function_id   = strip_tags(trim($_GET['Function_id']));
$Customers_id  = strip_tags(trim($_GET['Customers_id']));
$dateI         = strip_tags(trim($_GET['dateI']));
$dateF         = strip_tags(trim($_GET['dateF']));
$method_id     = strip_tags(trim($_GET['method_id']));
